...
Win32ConsoleName = 'OdooLauncher-Console-X86.exe'
Win32WindowName = 'OdooLauncher-X86.exe'
...
# Create GUI Version
Win32Exe = Executable(
    script = "OdooLauncher.py",
    initScript = None,
    base = 'Win32GUI',
    targetName = "OdooLauncher-" + x86x64 + ".exe",
    compress = True,
...
ConsoleExe = Executable(
    ...
    initScript = None,
    base = 'Console',
    targetName = "OdooLauncher-Console-" + x86x64 + ".exe",
    compress = True,
    copyDependentFiles = True,
    appendScriptToExe = True,
    appendScriptToLibrary = False,
...
shutil.copy('build/' + x86x64BuildPath + '/lib' + x86x64 + '/OdooLauncher-' + x86x64 + '.exe', 'build/' + x86x64BuildPath + '/OdooLauncher-' + x86x64 + '.exe')
shutil.copy('build/' + x86x64BuildPath + '/lib' + x86x64 + '/OdooLauncher-Console-' + x86x64 + '.exe', 'build/' + x86x64BuildPath + '/OdooLauncher-Console-' + x86x64 + '.exe')
...
os.remove('build/' + x86x64BuildPath + '/lib' + x86x64 + '/OdooLauncher-' + x86x64 + '.exe')
os.remove('build/' + x86x64BuildPath + '/lib' + x86x64 + '/OdooLauncher-Console-' + x86x64 + '.exe')
...
if copyRuntime == True:
    if not os.path.isdir('RuntimeClean'):
        ...
        shutil.copytree('Runtime', '!RELEASE_' + x86x64 + '/App/Runtime')
    else:
...
shutil.copyfile(scriptpathParentFolder + '/Other/Source/OdooPortable.exe', '!RELEASE_' + x86x64 + '/OdooPortable.exe')
os.remove('!RELEASE_' + x86x64 + '/Other/Source/OdooPortable.exe')
